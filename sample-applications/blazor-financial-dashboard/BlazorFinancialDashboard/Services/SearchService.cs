...
public class SearchService
{
    private readonly List<SearchablePage> Data = new()
    {
        ...
        new SearchablePage("Investments", "total investment invest chart stocks bonds real estate mutual funds crypto currency commodities today top movers btc bitcoin eth ethereum xrp ripple tth tether unicornlistview stock chart stockchart"),
