...
public class PatientService
{
    ...
    public List<PatientModel> GetPatients()
    {
            return new List<PatientModel>
        {
            new() { Id = 1, Name = "James Wilson", Initials = "JW", Age = 44, Status = PatientStatus.Monitoring, Gender = "Male", BloodType = "A+", Ward = "General", Diagnosis = "Persistent cough",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 28), Reason = "Lab work – CBC, CMP", Doctor = "Dr. Carter" }, new() { Date = new DateTime(2026, 3, 20), Reason = "Initial visit – cough evaluation", Doctor = "Dr. Carter" } }
            },
            new() { Id = 2, Name = "Sophia Martinez", Initials = "SM", Age = 31, Status = PatientStatus.Stable, Gender = "Female", BloodType = "O+", Ward = "Neurology", Diagnosis = "Migraines",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 26), Reason = "Migraine review", Doctor = "Dr. Patel" }, new() { Date = new DateTime(2026, 3, 10), Reason = "Neurology consult", Doctor = "Dr. Patel" } }
            },
            new() { Id = 3, Name = "Daniel Thompson", Initials = "DT", Age = 58, Status = PatientStatus.Critical, Gender = "Male", BloodType = "B+", Ward = "Cardiology", Diagnosis = "Acute MI",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 29), Reason = "Emergency admission – chest pain", Doctor = "Dr. Reeves" }, new() { Date = new DateTime(2026, 2, 15), Reason = "Cardiology follow-up", Doctor = "Dr. Reeves" } }
            },
            new() { Id = 4, Name = "Ava Patel", Initials = "AP", Age = 27, Status = PatientStatus.Stable, Gender = "Female", BloodType = "AB+", Ward = "General", Diagnosis = "Allergic dermatitis",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 27), Reason = "Skin rash follow-up", Doctor = "Dr. Carter" }, new() { Date = new DateTime(2026, 3, 18), Reason = "Allergy testing", Doctor = "Dr. Brooks" } }
            },
            new() { Id = 5, Name = "Michael O'Connor", Initials = "MO", Age = 62, Status = PatientStatus.Monitoring, Gender = "Male", BloodType = "O-", Ward = "Cardiology", Diagnosis = "Hypertension",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 25), Reason = "BP monitoring", Doctor = "Dr. Carter" }, new() { Date = new DateTime(2026, 3, 12), Reason = "Medication adjustment", Doctor = "Dr. Carter" } }
            },
            new() { Id = 6, Name = "Emily Chen", Initials = "EC", Age = 35, Status = PatientStatus.Monitoring, Gender = "Female", BloodType = "A-", Ward = "General", Diagnosis = "Chronic fatigue",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 24), Reason = "Fatigue follow-up", Doctor = "Dr. Carter" }, new() { Date = new DateTime(2026, 3, 8), Reason = "Initial evaluation", Doctor = "Dr. Carter" } }
            },
            new() { Id = 7, Name = "Alexander Novak", Initials = "AN", Age = 52, Status = PatientStatus.Stable, Gender = "Male", BloodType = "B-", Ward = "Pulmonology", Diagnosis = "COPD",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 22), Reason = "Pulmonary function test", Doctor = "Dr. Hernandez" }, new() { Date = new DateTime(2026, 3, 5), Reason = "COPD management review", Doctor = "Dr. Hernandez" } }
            },
            new() { Id = 8, Name = "Isabella Rossi", Initials = "IR", Age = 40, Status = PatientStatus.Stable, Gender = "Female", BloodType = "O+", Ward = "General", Diagnosis = "Annual physical",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 29), Reason = "Annual physical exam", Doctor = "Dr. Carter" } }
            },
            new() { Id = 9, Name = "Benjamin Carter", Initials = "BC", Age = 47, Status = PatientStatus.Monitoring, Gender = "Male", BloodType = "A+", Ward = "Gastroenterology", Diagnosis = "GERD",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 23), Reason = "GERD follow-up", Doctor = "Dr. Lopez" }, new() { Date = new DateTime(2026, 3, 1), Reason = "Upper GI endoscopy", Doctor = "Dr. Lopez" } }
            },
            new() { Id = 10, Name = "Olivia Grant", Initials = "OG", Age = 29, Status = PatientStatus.Stable, Gender = "Female", BloodType = "B+", Ward = "Orthopedics", Diagnosis = "ACL tear",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 28), Reason = "Pre-op assessment", Doctor = "Dr. Kim" }, new() { Date = new DateTime(2026, 3, 15), Reason = "MRI review – ACL tear confirmed", Doctor = "Dr. Kim" } }
            },
            new() { Id = 11, Name = "Lucas Rivera", Initials = "LR", Age = 71, Status = PatientStatus.Critical, Gender = "Male", BloodType = "AB-", Ward = "ICU", Diagnosis = "Sepsis",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 29), Reason = "ICU admission – septic shock", Doctor = "Dr. Reeves" } }
            },
            new() { Id = 12, Name = "Mia Johansson", Initials = "MJ", Age = 24, Status = PatientStatus.Stable, Gender = "Female", BloodType = "O+", Ward = "General", Diagnosis = "Tonsillitis",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 28), Reason = "Sore throat evaluation", Doctor = "Dr. Carter" } }
            },
            new() { Id = 13, Name = "Ethan Brooks", Initials = "EB", Age = 56, Status = PatientStatus.Monitoring, Gender = "Male", BloodType = "A+", Ward = "Cardiology", Diagnosis = "Atrial fibrillation",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 26), Reason = "INR check", Doctor = "Dr. Reeves" }, new() { Date = new DateTime(2026, 3, 14), Reason = "ECG monitoring", Doctor = "Dr. Reeves" } }
            },
            new() { Id = 14, Name = "Charlotte Adams", Initials = "CA", Age = 38, Status = PatientStatus.Stable, Gender = "Female", BloodType = "B+", Ward = "General", Diagnosis = "Iron deficiency anemia",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 25), Reason = "Anemia follow-up", Doctor = "Dr. Carter" }, new() { Date = new DateTime(2026, 3, 10), Reason = "Initial blood work review", Doctor = "Dr. Carter" } }
            },
            new() { Id = 15, Name = "William Tanaka", Initials = "WT", Age = 65, Status = PatientStatus.Monitoring, Gender = "Male", BloodType = "O-", Ward = "Endocrinology", Diagnosis = "Type 2 Diabetes",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 24), Reason = "Diabetes management review", Doctor = "Dr. Nguyen" }, new() { Date = new DateTime(2026, 3, 3), Reason = "HbA1c lab draw", Doctor = "Dr. Nguyen" } }
            },
            new() { Id = 16, Name = "Amelia Foster", Initials = "AF", Age = 33, Status = PatientStatus.Stable, Gender = "Female", BloodType = "AB+", Ward = "Dermatology", Diagnosis = "Psoriasis",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 22), Reason = "Psoriasis flare review", Doctor = "Dr. Brooks" }, new() { Date = new DateTime(2026, 2, 28), Reason = "Biologic therapy check", Doctor = "Dr. Brooks" } }
            },
            new() { Id = 17, Name = "Jack Sullivan", Initials = "JS", Age = 73, Status = PatientStatus.Critical, Gender = "Male", BloodType = "A-", Ward = "ICU", Diagnosis = "Pneumonia",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 29), Reason = "ICU transfer – worsening pneumonia", Doctor = "Dr. Hernandez" }, new() { Date = new DateTime(2026, 3, 27), Reason = "Admission – community-acquired pneumonia", Doctor = "Dr. Carter" } }
            },
            new() { Id = 18, Name = "Grace Kim", Initials = "GK", Age = 42, Status = PatientStatus.Stable, Gender = "Female", BloodType = "O+", Ward = "General", Diagnosis = "Seasonal allergies",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 20), Reason = "Allergy management visit", Doctor = "Dr. Carter" } }
            },
            new() { Id = 19, Name = "Henry Wallace", Initials = "HW", Age = 80, Status = PatientStatus.Monitoring, Gender = "Male", BloodType = "B-", Ward = "Neurology", Diagnosis = "Parkinson's disease",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 21), Reason = "Tremor assessment", Doctor = "Dr. Patel" }, new() { Date = new DateTime(2026, 2, 28), Reason = "Medication titration", Doctor = "Dr. Patel" } }
            },
            new() { Id = 20, Name = "Lily Nakamura", Initials = "LN", Age = 19, Status = PatientStatus.Stable, Gender = "Female", BloodType = "A+", Ward = "General", Diagnosis = "Mononucleosis",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 27), Reason = "Fatigue and sore throat", Doctor = "Dr. Carter" } }
            },
            new() { Id = 21, Name = "Samuel Torres", Initials = "ST", Age = 55, Status = PatientStatus.Stable, Gender = "Male", BloodType = "O+", Ward = "Orthopedics", Diagnosis = "Hip replacement recovery",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 26), Reason = "Post-op day 3 – hip replacement", Doctor = "Dr. Kim" }, new() { Date = new DateTime(2026, 3, 23), Reason = "Surgery – total hip arthroplasty", Doctor = "Dr. Kim" } }
            },
            new() { Id = 22, Name = "Chloe Anderson", Initials = "CA", Age = 48, Status = PatientStatus.Monitoring, Gender = "Female", BloodType = "AB+", Ward = "Oncology", Diagnosis = "Breast cancer – stage II",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 25), Reason = "Chemotherapy cycle 3", Doctor = "Dr. Liu" }, new() { Date = new DateTime(2026, 3, 11), Reason = "Chemotherapy cycle 2", Doctor = "Dr. Liu" } }
            },
            new() { Id = 23, Name = "Nathan Perry", Initials = "NP", Age = 36, Status = PatientStatus.Stable, Gender = "Male", BloodType = "B+", Ward = "General", Diagnosis = "Lower back pain",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 24), Reason = "Back pain evaluation", Doctor = "Dr. Carter" } }
            },
            new() { Id = 24, Name = "Zoe Mitchell", Initials = "ZM", Age = 83, Status = PatientStatus.Monitoring, Gender = "Female", BloodType = "O-", Ward = "Cardiology", Diagnosis = "Congestive heart failure",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 26), Reason = "CHF exacerbation", Doctor = "Dr. Reeves" }, new() { Date = new DateTime(2026, 3, 10), Reason = "Cardiology follow-up", Doctor = "Dr. Reeves" } }
            },
            new() { Id = 25, Name = "Ryan Cooper", Initials = "RC", Age = 45, Status = PatientStatus.Stable, Gender = "Male", BloodType = "A+", Ward = "General", Diagnosis = "Anxiety disorder",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 22), Reason = "Medication review", Doctor = "Dr. Carter" }, new() { Date = new DateTime(2026, 2, 20), Reason = "Anxiety management", Doctor = "Dr. Carter" } }
            },
            new() { Id = 26, Name = "Hannah Moore", Initials = "HM", Age = 60, Status = PatientStatus.Stable, Gender = "Female", BloodType = "B-", Ward = "Rheumatology", Diagnosis = "Rheumatoid arthritis",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 20), Reason = "RA flare assessment", Doctor = "Dr. Singh" }, new() { Date = new DateTime(2026, 2, 18), Reason = "Lab monitoring", Doctor = "Dr. Singh" } }
            },
            new() { Id = 27, Name = "Dylan Murphy", Initials = "DM", Age = 22, Status = PatientStatus.Stable, Gender = "Male", BloodType = "O+", Ward = "Orthopedics", Diagnosis = "Fractured wrist",
                ...
                Medications = new() { new() { Name = "Acetaminophen", Dosage = "500mg every 6h" } },
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 28), Reason = "Cast application – distal radius fracture", Doctor = "Dr. Kim" } }
            },
            new() { Id = 28, Name = "Victoria Hughes", Initials = "VH", Age = 50, Status = PatientStatus.Monitoring, Gender = "Female", BloodType = "A-", Ward = "Nephrology", Diagnosis = "Chronic kidney disease",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 24), Reason = "CKD stage 3b review", Doctor = "Dr. Nguyen" }, new() { Date = new DateTime(2026, 3, 5), Reason = "Lab monitoring", Doctor = "Dr. Nguyen" } }
            },
            new() { Id = 29, Name = "Oscar Fernandez", Initials = "OF", Age = 68, Status = PatientStatus.Stable, Gender = "Male", BloodType = "AB+", Ward = "General", Diagnosis = "Osteoarthritis",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 22), Reason = "Joint pain follow-up", Doctor = "Dr. Carter" }, new() { Date = new DateTime(2026, 2, 15), Reason = "Knee X-ray review", Doctor = "Dr. Kim" } }
            },
            new() { Id = 30, Name = "Ella Patterson", Initials = "EP", Age = 26, Status = PatientStatus.Stable, Gender = "Female", BloodType = "O+", Ward = "General", Diagnosis = "Urinary tract infection",
                ...
                RecentVisits = new() { new() { Date = new DateTime(2026, 3, 28), Reason = "UTI symptoms – dysuria, frequency", Doctor = "Dr. Carter" } }
            },
        };
    }
    ...
    public PatientDetailModel? GetPatientDetail(int id)
    {
        ...
        return new PatientDetailModel
        {
            ...
            AdmissionDate = new DateTime(2026, 3, Math.Min(5 + rng.Next(0, 24), 31)),
