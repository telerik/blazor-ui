...
namespace Demo.Notification.Controls.MessageBox
{
    public class MessageBoxService
    {
        public event Action<string, string, MessageBoxButtonTypeEnum, Action<MessageBoxResultEnum>> OnShowMessageBox;

        public void Show(string title, string message, MessageBoxButtonTypeEnum buttonType,
            Action<MessageBoxResultEnum> actionToInvoke)
        {
