...
BEGIN
    INSERT INTO [dbo].[Sales]
        ...
        VALUES
        (1, 5, DATEADD(day, -270, CURRENT_TIMESTAMP)),
        (1, 1, DATEADD(day, -269, CURRENT_TIMESTAMP)),
        (1, 2, DATEADD(day, -250, CURRENT_TIMESTAMP)),
        (1, 53, DATEADD(day, -231, CURRENT_TIMESTAMP)),
        (1, 10, DATEADD(day, -200, CURRENT_TIMESTAMP)),
        (4, 13, DATEADD(day, -99, CURRENT_TIMESTAMP)),
        (4, 11, DATEADD(day, -95, CURRENT_TIMESTAMP)),
        (4, 30, DATEADD(day, -80, CURRENT_TIMESTAMP)),
        (4, 30, DATEADD(day, -69, CURRENT_TIMESTAMP)),
        (4, 60, DATEADD(day, -69, CURRENT_TIMESTAMP)),
        (4, 410, DATEADD(day, -22, CURRENT_TIMESTAMP)),
        (4, 110, DATEADD(day, -21, CURRENT_TIMESTAMP)),
        (5, 1, DATEADD(day, -15, CURRENT_TIMESTAMP)),
        (3, 11, DATEADD(day, -14, CURRENT_TIMESTAMP)),
        (5, 3, DATEADD(day, -14, CURRENT_TIMESTAMP)),
        (3, 43, DATEADD(day, -12, CURRENT_TIMESTAMP)),
        (3, 92, DATEADD(day, -11, CURRENT_TIMESTAMP)),
        (4, 120, DATEADD(day, -10, CURRENT_TIMESTAMP)),
        (2, 10, DATEADD(day, -9, CURRENT_TIMESTAMP)),
        (3, 12, DATEADD(day, -9, CURRENT_TIMESTAMP)),
        (2, 100, DATEADD(day, -8, CURRENT_TIMESTAMP)),
        (3, 10, DATEADD(day, -7, CURRENT_TIMESTAMP)),
        (2, 3, DATEADD(day, -6, CURRENT_TIMESTAMP)),
